...
namespace EditorAttributesSamples
{
	...
	public class TabGroupSample : MonoBehaviour
	{
		...
		[SerializeField] private VoidStructure tabGroup;

		[VerticalGroup(nameof(intField01), nameof(intField02))]
		[SerializeField, HideInInspector] private VoidStructure intGroup;

		[VerticalGroup(nameof(stringField01), nameof(stringField02), nameof(stringField03))]
		[SerializeField, HideInInspector] private VoidStructure stringGroup;

		[VerticalGroup(true, nameof(boolField01), nameof(boolField02))]
		[SerializeField, HideInInspector] private VoidStructure boolGroup;
