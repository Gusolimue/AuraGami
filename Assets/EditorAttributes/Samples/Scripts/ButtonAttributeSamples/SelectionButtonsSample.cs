...
namespace EditorAttributesSamples
{
	...
	public class SelectionButtonsSample : MonoBehaviour
	{
		...
		[SerializeField, HelpBox("This attribute has been deprecated use the <b>EnumButtons Attribute</b> instead", MessageMode.Warning)] private EditorAttributes.VoidStructure helpBoxHolder;
#else
